...
<div class="row">
  ...
  <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="studetail.php"><strong>Student Details</strong></a></li>
 <li class="active" style="font-family:calibri; font-size:16px;"><a style="color:#000" href="healthcheck.php"><strong>Health Check List</strong></a></li>
...
<h3 style="font-family:calibri;" class="text-center">All Student</h3></div>
</div>
</div>
</div>
...
<div class="row">
<div class="col-md-12">
<h4 style="font-family:calibri;" class="text-center">All registerd student in system.</h4>
<br />
